    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(NEEDS.this, "FILL ALL DETAILS", Toast.LENGTH_SHORT).show();
                }
                else {
                    String id = databaseReference.push().getKey();
                    NeedsDetail needsDetail = new NeedsDetail(id,nname,nemail,nneeds);
                    databaseReference.child(id).setValue(needsDetail);
                    ename.setText("");
                    eemail.setText("");
                    eneeds.setText("");
                    Toast.makeText(NEEDS.this, "NEEDS FILED", Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(NEEDS.this,DASHBOARD.class);
