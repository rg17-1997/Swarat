...
import com.example.lenovo.navigationex.R;
import com.example.lenovo.navigationex.Uploadimagescomplain;
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Uploadimagescomplain upload = new Uploadimagescomplain(mEditTextFileName.getText().toString().trim(),
