...
eimageiupload.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        Intent intent=new Intent(COMPLAIN.this,UPLOADIMAGE.class);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               if(consname.isEmpty()||conscomplaint.isEmpty()||conspincode.isEmpty()||consaddress.isEmpty()||consstate.isEmpty()||conscity.isEmpty())
              {
                  ...
                  Toast.makeText(COMPLAIN.this, "FILL ALL DETAILS", Toast.LENGTH_SHORT).show();
               }
                else
                {
                    ...
                    //sendUserData();
                    ComplainDetail complainDetail = new ComplainDetail(id,consname,consaddress,conscity,consstate,conspincode,conscomplaint);
                    ...
                    Toast.makeText(COMPLAIN.this, "Complaint sent", Toast.LENGTH_SHORT).show();
